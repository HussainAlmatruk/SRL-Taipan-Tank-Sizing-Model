...
m_ox = m_dot_ox*t_burn_s/(1-residual_fraction);         % [kg] Total mass of oxidizer at liftoff
...
equations = ...
    ...
    m_tank_fuel == material_density_fuel_kgm3 * pi * ((D/2)^2-(D/2-t_tank_fuel)^2)*L_cyl_fuel + 4/3 * pi * ((D/2)^3-(D/2-t_tank_fuel)^3)...
    ...
    V_tank_ox == (m_ox / ox_density_kgm3) / (1 - ullage_fraction)...
    ... Valculate volume of fuel tank from volume of oxidizer and the ullage fraction
    V_tank_fuel == (m_fuel / fuel_density_kgm3) / (1 - ullage_fraction)...
    ...
    p_storage_pressurant_pa * V_tank_pressurant == n_pressurant * R_universal_jmolk * pressurant_temp_k...
